"""
Django settings for arka_backend project.
...
ROOT_URLCONF = 'arka_backend.urls'
...
WSGI_APPLICATION = 'arka_backend.wsgi.application'
...
# Production: Use SMTP backend to send real emails
if DEBUG:
...
# Email timeout (in seconds) to prevent hangs
EMAIL_TIMEOUT = config('EMAIL_TIMEOUT', default=10, cast=int)

# Payment gateway keys removed — using manual payment workflow

# Static files configuration (development only)
STATIC_URL = '/static/'
